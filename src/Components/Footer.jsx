      ...
      <div className="flex flex-col sm:flex-row pl-10 md:pl-20 pt-4 ">
        <div className="footer-section mb-4 sm:mb-0 md:w-1/2 ">
          ...
          <div className="flex items-center">
            <AiOutlinePhone className="mr-2 text-xl" /> {/* Adjust the margin as needed */}
            <p>604-445-6469<br /> 236-808-4298</p>
          </div>
          <div className="flex items-center">
            <AiOutlineMail className="mr-2 text-xl" /> {/* Adjust the margin as needed */}
            <p>Memorylanecomp@gmail.com</p>
          </div>
          <div className="flex items-center">
            <AiOutlineInstagram className="mr-2 text-xl" /> {/* Adjust the margin as needed */}
            <p>@memorylanevancity</p>
          </div>
